...
async function addTermsAndTest() {
  let conn;
  try {
    ...
    console.log('Adding terms column and testing...\n');

    // Step 1: Add terms column
    console.log('Step 1: Adding terms column...');
    try {
      await conn.execute(`
      ...
      if (err.code === 'ER_DUP_FIELDNAME') {
        console.log('⚠ terms already exists\n');
      } else {
        throw err;
      }
    }
